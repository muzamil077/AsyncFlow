...
exports.analyzeThread = exports.createPost = exports.getDiscussion = exports.getDiscussions = exports.createDiscussion = void 0;
...
const analyzeThread = async (req, res) => {
    try {
        ...
        const analysis = await (0, aiService_1.analyzeDiscussionThread)(threadText);
        res.json(analysis);
    }
    catch (error) {
